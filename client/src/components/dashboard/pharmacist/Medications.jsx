  ...
  return (
    <div className="overflow-x-auto mt-8 w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 p-4 border rounded-md shadow-md bg-white">
          ...
          <div className="flex items-center space-x-2 gap-3">
            <input
              ...
              name="available"
              type="checkbox"
              checked={medicationForm.available}
              onChange={handleInputChange}
      ...
      <table className="min-w-full table-auto border-collapse">
        <thead>
          <tr>
            <th className="px-4 py-2 text-center bg-blue-500 text-white">الاسم</th>
            ...
            <th className="px-4 py-2 text-center bg-blue-500 text-white">متاح</th>
            <th className="px-4 py-2 text-center bg-blue-500 text-white">تعديل</th>
            <th className="px-4 py-2 text-center bg-blue-500 text-white">حذف</th>
          </tr>
        </thead>
        <tbody>
          {medications.length > 0 && medications.map((medication) => (
            <tr key={medication._id} className="border-t">
              ...
              <td className="px-4 py-2 text-center">{medication.available ? "نعم" : "لا"}</td>
